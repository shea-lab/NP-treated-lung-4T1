...
```{r}
saveRDS(data, file = "~./Data/lung_integrated_merged_sct_filtered_object.rds")
```
...
# Save Object
```{r}
saveRDS(data, file = "~./Data/labeled_lung_int_merge_sct_filt_tnbc.rds")
...
saveRDS(neut, file = "~./Data/lung_neutrophil.rds")

recMac <- subset(data, idents = c("recMac"))
saveRDS(recMac, file = "~./Data/lung_recruited_macrophage.rds")

mac <- subset(data, idents = c("Macrophage"))
saveRDS(mac, file = "~./Data/lung_macrophage.rds")

alvMac <- subset(data, idents = c("alvMac"))
saveRDS(alvMac, file = "~./Data/lung_alveolar_macrophage.rds")

allMac <- subset(data, idents = c("Macrophage", "recMac", "alvMac"))
saveRDS(allMac, file = "~./Data/lung_all_macrophage.rds")

allMyeloid <- subset(data, idents = c("Macrophage", "recMac", "alvMac", "Neutrophil", "Unknown 1", "Unknown 2"))
saveRDS(allMyeloid, file = "~./Data/lung_all_myeloid.rds")
...
saveRDS(tcell, file = "~./Data/lung_tcell.rds")

bcell <- subset(data, idents = c("B cell"))
saveRDS(tcell, file = "~./Data/lung_bcell.rds")

endo <- subset(data, idents = c("Endothelial"))
saveRDS(endo, file = "~./Data/lung_endothelial.rds")

nkcell <- subset(data, idents = c("NK cell"))
saveRDS(tcell, file = "~./Data/lung_nkcell.rds")

fibro <- subset(data, idents = c("Fibroblast"))
saveRDS(fibro, file = "~./Data/lung_fibroblast.rds")

cancer <- subset(data, idents = c("4T1"))
saveRDS(fibro, file = "~./Data/lung_4T1_cancer.rds")
